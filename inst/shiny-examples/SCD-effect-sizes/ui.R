                 ...
                 tabPanel("Calculator",
                          ...
                          sidebarLayout(
                            ...
                            tabsetPanel(id = "ES_family", type = "pills",
                                        ...
                                        conditionalPanel(condition = "input.parametric_ES=='LOR'|input.parametric_ES=='LRRi'|input.parametric_ES=='LRRd'",
                                                        numericInput("lrrfloor", label = "Optionally, specify your floor constant.",value = NULL))),
                            ...
                            tabPanel("Estimate", 
                                     sidebarLayout(
                                       sidebarPanel(
                                         ...
                                         conditionalPanel(condition = "input.bESpar.includes('LOR')", HTML("<font color=\"#FF0000\">No LOR will be calculated for data not measured in percentage or proportions.</font>")),
