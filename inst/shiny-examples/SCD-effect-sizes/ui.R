                          ...
                          sidebarLayout(
                            ...
                            tabsetPanel(id = "ES_family", type = "pills",
                                        ...
                                        conditionalPanel(condition = "input.parametric_ES=='LRRi'|input.parametric_ES=='LRRd'",
                                                        numericInput("obslength", label = "Observation session length in minutes.", value = NULL)),
                                        conditionalPanel(condition = "input.parametric_ES=='LOR'|input.parametric_ES=='LRRi'|input.parametric_ES=='LRRd'",
                                                        numericInput("lrrfloor", label = "Optionally, specify your own log-response ratio floor.",value = NULL))),
                            ...
                            tabPanel("Estimate", 
                                     sidebarLayout(
                                       sidebarPanel(
                                         ...
                                         conditionalPanel(condition = "input.bESpar == 'LOR'", HTML("<font color=\"#FF0000\">No LOR will be calculated for data not measured in percentage or proportions.</font>")),
