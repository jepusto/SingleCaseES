                 ...
                 tabPanel("Calculator",
                          ...
                          sidebarLayout(
                            ...
                            tabsetPanel(id = "ES_family", type = "pills",
                                        ...
                                        conditionalPanel(condition = "input.parametric_ES == 'LRR'",
                                                        selectInput("measurementProcedure", 
                                                                    label = "Measurement Procedure",
                                                                    choices = c("continuous recording", 
                                                                                "interval recording", 
                                                                                "event counting", 
                                                                                "other")),
                                                        selectInput("outScale", label = "Outcome Scale",
                                                          choices = c("percentage", 
                                                                      ...
                                                                      "rate", 
                                                                      "other")),
                                                        numericInput("lrrfloor", label = "Log-response ratio floor. Must be greater than or equal to 0.",
                                                                     value = 0,
                                                                     min = 0)),
