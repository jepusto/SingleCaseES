...
> Pustejovsky, J. E., Chen, M., & Swan, D. M. (2022). SingleCaseES: A calculator for single-case effect size indices (Version `r packageVersion("SingleCaseES")`) [R package]. https://jepusto.github.io/SingleCaseES/

Please cite the web applications as follows:

> Pustejovsky, J. E., Chen, M., & Swan, D. M. (2022). Single-case effect size calculator (Version `r packageVersion("SingleCaseES")`) [Web application].  https://jepusto.shinyapps.io/SCD-effect-sizes
